...
public interface TatraEquipmentAdvisorConnectorable {
    ...
    default void sendTripDataRequest(TripData tripData) {}

    default EquipmentProposal getEquipmentProposal() {
        return new EquipmentProposal();
    }
}
